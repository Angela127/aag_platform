  ...
  return (
    <div style={{ padding: '40px 24px', maxWidth: '1200px', margin: '0 auto' }}>
      <div className="card" style={{ padding: '40px', textAlign: 'center', background: 'var(--white)' }}>
        <h1 style={{ fontSize: '2rem', color: 'var(--text-primary)', marginBottom: '12px' }}>Client Management</h1>
        <p style={{ color: 'var(--text-secondary)', maxWidth: '500px', margin: '0 auto 24px' }}>
          Secure CRM hub containing client portfolios, insurance schedules, and KYC compliance records.
        </p>
